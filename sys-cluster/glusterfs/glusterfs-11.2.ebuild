...
SRC_URI="https://github.com/gluster/glusterfs/tarball/744c3be74b22dde775ad61972f81ab44c2e52d18 -> glusterfs-11.2-744c3be.tar.gz"
...
RESTRICT="test"
PATCHES=(
	"${FILESDIR}"/"${PN}-11.0-extras-defer-invoking-of-gluster-volume-set-help.patch"
)
